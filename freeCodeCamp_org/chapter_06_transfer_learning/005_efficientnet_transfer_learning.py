...
model.classifier[1] = nn.Linear(in_features=1280, out_features=dataset.number_classes, bias=True)
...
engine.train(model=model,
             model_filename='efficientnet.pth',
             use_check_point=True,
             save_best_model=True,
             train_dataloader=dataset.data_train,
             test_dataloader=dataset.data_test,
             optimizer=optimizer,
