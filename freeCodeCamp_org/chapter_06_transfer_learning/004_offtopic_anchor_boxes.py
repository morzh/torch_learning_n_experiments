...
https://www.youtube.com/watch?v=-t1MyeIk2IE
'''
import torch
...
def box_iou(boxes1, boxes2):
    ...
    # Shape of `inter_upper_lefts`, `inter_lower_rights`, `inters`: (no. of
...
X = torch.rand(size=(1, 3, height, width))  # Construct input data
...
# EXAMPLE Restoring bounding boxes after prediction
